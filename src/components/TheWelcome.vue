      ...
      <div class="container-fluid">
        ...
        <div class="row mt-3">
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/01.jpg" alt="not found" width="100%" height="auto" />
                <img class="first" src="../assets/images/001.jpg" alt="not found" width="100%" height="auto"/>
              </div>
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/02.jpg" alt="not found" width="100%" height="auto" />
                <img class="first" src="../assets/images/002.jpg" alt="not found" width="100%" height="auto"/>
              </div>
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/03.jpg" alt="not found" width="100%" height="auto"/>
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/04.jpg" alt="not found" width="100%" height="auto"/>
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/05.jpg" alt="not found" width="100%" height="auto" />
          ...
          <div class="col-md-2 d-flex align-items-center justify-content-center mb-2">
            <div class="images">
              <div class="image text-center image-main-div">
                <img src="../assets/images/06.jpg" alt="not found" width="100%" height="auto" />
